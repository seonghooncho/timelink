      ...
      <main className="px-5 py-5 space-y-6">
        <section className="rounded-xl border border-border bg-card p-4">
          ...
          <p className="mt-2 text-xs leading-6 text-muted-foreground">
            본 약관은 Timelink의 일정 관리, 모임, 일정 조율, 알림 기능 이용 조건을 정합니다.
        ...
        <Section title="1. 서비스 내용">
          <p>
            Timelink는 개인 일정 등록, 모임 일정 공유, 일정 조율, 공개 모임 가입요청, 알림 기능을 제공합니다.
        ...
        <Section title="2. 계정과 로그인">
          <p>
            이용자는 서비스에서 제공하는 소셜 로그인을 통해 서비스를 사용할 수 있습니다.
            이용자는 자신의 계정으로 발생한 활동을 관리해야 하며, 타인의 계정이나 모임 초대 정보를 부정하게 사용해서는 안 됩니다.
          </p>
        </Section>

        <Section title="3. 이용자 콘텐츠">
          <p>
            이용자가 등록한 일정, 모임, 이미지, 조율 응답, 가입요청 인삿말의 책임은 이용자에게 있습니다.
        ...
        <Section title="4. 금지 행위">
          <ul className="list-disc pl-4 space-y-1.5">
            <li>타인의 개인정보, 계정, 모임 정보를 무단으로 이용하는 행위</li>
        ...
        <Section title="5. 알림">
          <p>
            이용자가 알림을 켜면 일정 리마인드와 모임 활동 알림을 받을 수 있습니다.
