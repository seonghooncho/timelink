...
class StorageControllerTest {
    ...
    @Test
    @DisplayName("POST /storage/images/profile 는 인증 없으면 401")
    void uploadProfileImage_unauthenticated() throws Exception {
    ...
    @DisplayName("POST /storage/images/profile 는 업로드 URL을 반환한다")
