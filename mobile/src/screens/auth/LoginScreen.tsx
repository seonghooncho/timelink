  ...
  return (
    <Screen hideTabSpacing contentContainerStyle={styles.container}>
      ...
      <View style={styles.legalRow}>
        <Text style={styles.footer}>로그인 시 </Text>
        <Pressable onPress={() => Linking.openURL(`${env.webAppOrigin}/terms`)}>
          <Text style={styles.legalLink}>이용약관</Text>
        </Pressable>
        <Text style={styles.footer}> 및 </Text>
        <Pressable onPress={() => Linking.openURL(`${env.webAppOrigin}/privacy`)}>
          <Text style={styles.legalLink}>개인정보 처리방침</Text>
        </Pressable>
        <Text style={styles.footer}>에 동의합니다</Text>
      </View>
    </Screen>
  );
}
